...
const data = computed(() => {
  ...
  return (videoInject && videoInject.params.captions) || [];
});

const setCaption = (item: any) => {
  if (videoInject?.setCaption) {
    videoInject.params.secondaryActiveCaption = item;
  }
};
</script>
